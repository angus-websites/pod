...
const classes = computed(() => {
    return props.active
        ? 'block pl-3 pr-4 py-2 border-l-4 border-secondary text-base font-medium text-secondary-700 bg-secondary-50 focus:outline-none focus:text-secondary-700 focus:bg-secondary-200 focus:border-secondary-700 transition'
