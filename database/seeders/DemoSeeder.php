...
class DemoSeeder extends Seeder
{
    ...
    private function populateBob($bob){
        ...
        $googleEntries = [
            [
                "My first day",
                "<h2>Dear Diary</h2> <br>Today was my first day at Google, and it was everything I imagined it to be and more! From the moment I stepped into the office, I could feel the energy and excitement in the air. My team welcomed me with open arms and wasted no time getting me up to speed on the projects I'll be working on this year. I'm already blown away by the level of talent and expertise I'm surrounded by, and I can't wait to see what the rest of the year has in store."
            ],
            [
                "Another day at Google",
                "<h2>Dear Diary</h2> <br>I can't believe how quickly time is flying by. It's been a few months since I started at Google, and I've already learned so much. I'm working on some really exciting projects with my team, and I feel like I'm constantly being challenged and pushed to my limits. The work can be intense at times, but the support and camaraderie of my colleagues make it all worth it. I'm so grateful for this opportunity and excited to see what the future holds.",
            ],
            [
                "Major update",
                "<h2>Dear Diary</h2> <br>Today was a big day at Google - we launched a major update to one of our flagship products! It's been months of hard work and late nights, but seeing the positive reception from users and the media is incredibly rewarding. I feel proud to have played a small role in such a significant milestone for the company. It's moments like this that make me appreciate even more the incredible culture and sense of purpose at Google.",
            ],
            [
                "About to finish",
                "<h2>Dear Diary</h2> <br>As my placement year at Google starts to wind down, I'm feeling a mix of emotions. On one hand, I'm sad to be leaving such an amazing company and team. On the other hand, I feel incredibly grateful for everything I've learned and accomplished this year. I've grown so much as a professional and as a person, and I know that the skills and experiences I've gained will serve me well in my future career. I'll miss Google, but I'm excited to see what the next chapter holds.",
            ],
            [
                "The end",
                "<h2>Dear Diary</h2> <br>Today is my last day at Google, and it's bittersweet. On one hand, I'm sad to say goodbye to my colleagues and the amazing company culture. On the other hand, I'm excited to take everything I've learned and apply it to the next chapter of my life. Google has been an incredible experience, and I feel incredibly lucky to have had this opportunity. I'll always be grateful for the memories, the lessons, and the friendships I've made here. Thank you, Google!"
            ],
        ];
        ...
        Entry::create([
            ...
            'data' => [
                ...
                'what_i_learned'=>
                "<h2>Pair Programming at Google</h2>
<p>Today I had my first experience with pair programming, and it was a great learning opportunity. Pair programming is a technique where two developers work together on the same codebase, with one person coding while the other reviews their work and provides feedback.</p>
<p>I was paired up with a more experienced developer, and I was initially nervous about working so closely with someone else. However, my partner was incredibly patient and supportive, and I quickly got used to the process. We were able to catch bugs and improve the quality of our code much faster than I would have been able to on my own.</p>
<p>I can see why pair programming is so highly valued at Google. Not only does it improve code quality, but it also fosters collaboration and communication within the team. I'm excited to continue practicing this technique and improving my skills as a developer.</p>",
                'date'=> $date->format("d-m-Y")
            ],
            'created_at' => $date
        ]);
